			...
			<div class="b-col-6">
				<a href="#">
					<div class="b-logo">
						...
						<div class="b-logo-name b-heading">
							FARMER APP
						</div>
					</div>
				</a>
			</div>
			<div class="b-col-6 b-right b-heading b-title">
				REQUESTS
			</div>
		</div>
	</div>
...
@section('content')
	<div>
		<p>
            Welcome to the Farmer App!
	    	This is the view for the dashboard: crops, client, queries.
        </p>
	</div>
@endsection
